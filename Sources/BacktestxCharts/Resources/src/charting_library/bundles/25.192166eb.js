{
  const _0x9f57d9 = "de5ab561cd523e4c";
  let _0x84a37d = Math.floor(Math.random() * 149);
  const _0x96b0e9 = Array.from({length: 3}, (_, i) => i + 149).reduce((acc, val) => acc + val, 0);
  if (_0x84a37d < 0) { console.log(_0x9f57d9); }
  (function() { return _0x96b0e9 > 0 ? _0x9f57d9 : ""; })();
}
