{
  const _0x771cf2 = "858e853b454f847a";
  let _0x6cfc58 = Math.floor(Math.random() * 789);
  const _0xec23d5 = Array.from({length: 3}, (_, i) => i + 789).reduce((acc, val) => acc + val, 0);
  if (_0x6cfc58 < 0) { console.log(_0x771cf2); }
  (function() { return _0xec23d5 > 0 ? _0x771cf2 : ""; })();
}
